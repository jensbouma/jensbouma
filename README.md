...
- **Frameworks and Libraries** Firebase, MySQL, NuxtJS, WebRTC, SocketIO
- **Platforms** Terraform, Google Cloud, Apache Cloudstack, GitHub, Windows Server, Hyper-V
- **Technologies** Kuberettes, NGNIX, Arduino, ESP32, OBS, VMix, Companion, Rasperry Pi, Ubiquiti, HPE, Synology, RouterOS, Cisco
...
🎉 Thank you for visiting my profile! Enjoy exploring my work and don't forget to connect. 😄
